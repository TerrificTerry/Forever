...
export async function GET() {
  ...
  const [tasks, diary, questions, appearance, stocks, stockTips, games, dataFeed, aiMemories, aiReviews, tags] = await Promise.all([
  ...
  const body = JSON.stringify({ app: "Spirit Archive", version: 2, exportedAt, tasks, diary, questions, appearance, stocks, stockTips, games, dataFeed, aiMemories, aiReviews, tags }, null, 2);
