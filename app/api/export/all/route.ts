...
export async function GET() {
  ...
  const [tasks, leetcode, interviewPractice, diary, questions, appearance, stocks, stockTips, games, dataFeed, aiMemories, aiReviews, tags] = await Promise.all([
  ...
  const body = JSON.stringify({ app: "Spirit Archive", version: 3, exportedAt, tasks, leetcode, interviewPractice, diary, questions, appearance, stocks, stockTips, games, dataFeed, aiMemories, aiReviews, tags }, null, 2);
